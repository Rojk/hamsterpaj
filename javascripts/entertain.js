...
{
	document.getElementById('entertain_upload_form').style.display = "block";
	document.getElementById('entertain_edit_form').style.display = "none";
	document.getElementById('entertain_upload_form_show_button').style.display = "none";
}
...
function open_fullscreen_window(target_url)
{
	...
	document.getElementById('entertain_player').innerHTML = '';
...
{
	document.getElementById('entertain_preview_buttons').style.display = "none";
	document.getElementById('entertain_edit_form').style.display = "block";
}
function entertain_preview_retry_button_click()
{
	document.getElementById('entertain_preview_buttons').style.display = "none";
	document.getElementById('entertain_preview').style.display = "none";
	document.getElementById('entertain_upload_form').style.display = "block";
	alert('/ajax-gateways/entertain.ajax.php?action=cancel_upload');
