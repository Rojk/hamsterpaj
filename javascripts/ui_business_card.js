	...
	business_card: function() {
	 	var html = '<div id="ui_business_card">' +
		 				...
		 				'<div id="ui_business_card_about">' +
		 					...
		 					'<p>' +
								'<img src="http://images.hamsterpaj.net/user_flags/computer_geek.png" alt="Datanörd" title="Datanörd" id="30">' +
								...
								'<img src="http://images.hamsterpaj.net/user_flags/teachers_pet.png" alt="Plugghäst" title="Plugghäst" id="78">' +
