	...
	if(is_privilegied('music_guess_admin'))
	{
		if(isset($_GET['filename']))
		{
			...
			for($i = 0; $i < count($times); $i++)
			{
				...
				echo '<div id="player1"><a href="http://www.macromedia.com/go/getflashplayer">Installera Flash Player</a> för att kunna se den här grejen.</div>
							<script type="text/javascript">
							var s1 = new SWFObject("/entertain/flvplayer.swf","single","465","20","7");
							s1.addParam("allowfullscreen","true");
							s1.addVariable("file","/music_guess/mp3/' . $file_id . '_' . $i . '.mp3");
							s1.addVariable("width","465");
