<?php
	...
	else
	{
		...
		$notout = '
			...
			<param name="movie" value="http://wandborg.se/xspf/xspf_player_slim.swf?song_url=http://images.hamsterpaj.net/music_guess_mp3/' . $data['secret_id']. '.mp3&song_title=test" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#e6e6e6" />
			<embed src="http://wandborg.se/xspf/xspf_player_slim.swf?song_url=http://images.hamsterpaj.net/music_guess_mp3/' . $data['secret_id']. '.mp3&song_title=test" quality="high" bgcolor="#e6e6e6" width="400" height="15" name="xspf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>';
		echo '<embed src="http://wandborg.se/xspf/xspf_player_slim.swf?song_url=http://images.hamsterpaj.net/music_guess_mp3/' . $data['secret_id']. '.mp3&song_title=test" quality="high" bgcolor="#e6e6e6" width="400" height="15" name="xspf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
