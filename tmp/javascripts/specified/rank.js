...
{var items=getElementsByClassName(document,'div','rank_input_part');for(var i=0;i<items.length;i++)
...
+'&rank='+(this.id.substr(16)/2));document.getElementById('rank_previous').value=this.id.substr(16)/2;rank_input_previous_reset();document.getElementById('rank_input_message').style.display='block';}}
...
womAdd('rank_input_mouse_out_enable()');womAdd('rank_input_part_mouse_over_enable()');womAdd('rank_input_part_click_enable()');womAdd('rank_input_previous_reset()');