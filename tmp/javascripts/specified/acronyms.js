...
{try
{var items=document.getElementById('acronyms').getElementsByTagName('li');for(var i=0;i<items.length;i++)
{items[i].onclick=expand_contract_acronym;}
var buttons=document.getElementById('acronyms').getElementsByTagName('input');for(var i=0;i<buttons.length;i++)
...
womAdd("make_acronyms_clickable()");womOn();}