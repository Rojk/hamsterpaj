...
womAdd('enable_fp_module_voting()');function fp_module_news_switch(titleid)
{var elems=getElementsByClassName(document,'div','fp_news_main');for(i=0;i<elems.length;i++)
