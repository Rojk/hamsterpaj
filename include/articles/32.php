...
<p>
	– <strong>Ursäkta, jag gör ett sista-minuten-arbete om nytänkande betalsystem. Jag tänkte
...
<img src="http://images.hamsterpaj.net/article_illustrations/presentkort/card_back.jpg" style="float: right; margin: 3px;" />
	<em>
		– Det där numret måste ju betyda någonting... Kanske är det så att det finns en databas
...
Nu har Henrik fyllt på originalkortet med 200kr, och om vår teori stämmer så ska mitt fejkkort ha samma summa.
	...
	<li>
		...
		<em>– Du har tvåhundra kronor på kortet</em>, säger tjejen leende och räcker över ett kvitto.
	</li>
...
<p>
	...
	<strong>– Varför i hela friden skriver en ungdomssajt en guide till hur man stjäl pengar
