<?php
	...
	{
		if($_SESSION['login']['username'] == 'mr_martini')
		{
			jscript_alert('Tjockis!! /Joel');
		}
		global $SIDE_MODULES;
...
function report_sql_error($query, $file = null, $line = null)
  {
    echo '<div class="server_message_error"><h2>Databaser är dumma :(</h2><p>Ett fel på hamsterpaj har inträffat! Utvecklingsansvariga har meddelats om detta, du behöver inte rapportera felet. Vi åtgärdar det snart (om vi kan :P)</p>';
