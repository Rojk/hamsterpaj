...
*/
	...
	//log_admin_event('logg_test','henrik testar', 1234, 4567, 7890);
...
//		if(!result)
//		{
			log_to_file('logging', LOGLEVEL_DEBUG, __FILE__, __LINE__, 'Database error when logging event: ' . mysql_error(), $query);
//		}
	}

/*
	function log_get_events(....
		$query = 'SELECT poster, timestamp, title, content, forum_thread FROM hpblog ORDER BY id DESC';
