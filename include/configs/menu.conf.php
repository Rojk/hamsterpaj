...
*/
 ...
 /* Administration */
	...
	$menu['admin'] = array('label' => 'Administration', 'url' => '/admin/start.php', 'is_privilegied' => $admin_privilegies, 'index_label' => 'Adminstart (ej klar)');
		...
		$menu['dev'] = array('label' => 'Dev', 'url' => '/admin/ajax_handy.php', 'index_label' => 'Handy encoder/decoder', 'is_privilegied' => 'use_debug_tools');
		...
		$menu['fra'] = array('label' => 'FRA', 'url' => '/admin/fra.php', 'index_label' => 'Start..', 'is_privilegied' => 'use_ghosting_tools');
		$menu['fra']['children']['pm_hack'] = array('label' => 'PM-hack', 'url' => '/admin/pm_hack.php', 'is_privilegied' => 'use_ghosting_tools');
		$menu['fra']['children']['guestbook_hack'] = array('label' => 'Gästbokshack', 'url' => '/admin/guestbook_hack.php', 'is_privilegied' => 'use_ghosting_tools');
		$menu['fra']['children']['user_ghost'] = array('label' => 'Ghosta', 'url' => '/admin/user_ghost.php', 'is_privilegied' => 'use_ghosting_tools');
		$menu['fra']['children']['user_logins'] = array('label' => 'User Logins', 'url' => '/admin/user_logins.php', 'is_privilegied' => 'ip_ban_admin');
